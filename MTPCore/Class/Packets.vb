...
Namespace Packet.Request
    ...
    Public Class ReadVariablesPacketV1_1
        ...
        Public Property VALUESLIST As List(Of Object)
            Get
                Return m_VALUESLIST
            End Get
            ...
            End Set
        End Property
        Private m_VALUESLIST As List(Of Object)
...
Namespace Packet.Answer
    ...
    Public Class ResponseGenericPacketV1_1
        ...
        ''' </summary>
        Public Property CODES As List(Of Object)
            Get
                Return m_CODES
            End Get
            Set(value As List(Of Object))
            ...
            End Set
        End Property
        Private m_CODES As List(Of Object)

        Public Sub New()
            VER = Common.Versioning(Common.MarathonVersion.V_1_1)
            RA = Common.AnswerCode
            CMD = CByte(Common.MessageCodes.WriteVariables)
            CODES = New List(Of Object)
        End Sub
    End Class
