...
#Region "Properties"
    ...
    ''' <summary>
    ''' Number of successfull message transcation per second. This value is evaluated every second. Automatically reset if value exceed 2,147,483,647.
    ''' </summary>
